 ...
 <div class="container-fluide bg-light p-3">
        <div class="row footer p-5">
            <div class="column">
                <h2 class="blue text-info">TECH care</h2>
                <p class="blue text-light"> <img src="unnamed.webp" alt="" style="width:50px;height: 48px;margin-right: 10px;">
                    TECHcare is an online system that allows 
                    you to book appointments with doctors online.
                    You can book an appointment with a doctor of your choice without having to
                    go through the hassle of visiting their clinic. </p>

            </div>
            <div class="column pl-3 link-12">
                <h4 class="blue fifty">QUICK LINKS</h4>
                <div class="line-34"></div>
                <table class="table mt-2 table-borderless quick-links">
                    <tbody>
                     <tr>
                         <td><a href="">home</a> </td>
                     </tr>
        ...
        <div class="row flex-footer-cloumn light-black py-3">
