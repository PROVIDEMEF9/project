    ...
    <div class="collapse navbar-collapse flex-end-2222 px-5" id="navbarSupportedContent">
      <ul class="navbar-nav  mb-2 mb-lg-0  flex-for-login-page">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-dark" href="#ss" role="button" data-toggle="dropdown" aria-expanded="false">
          Services
          </a>
          <ul class="dropdown-menu text-dark" href="#ss">
                        <li><a class="dropdown-item" href="#ss">Regular checkup</a></li>
                        <li><a class="dropdown-item" href="#ss">Appoinment booking</a></li>
                        <li><a class="dropdown-item" href="#ss">Health issue</a></li>
         </ul>
        </li>
        <li class="nav-item">
                    ...
                    <li class="nav-item dropdown ">
                      <a class="nav-link dropdown-toggle text-dark" href="#k" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
